...
public:
    Pipe(std::vector<glm::vec3>& pathPoints,float topRadius=0.5f,float baseRadius=0.5f,int slices = 16, const char* vertexPath=DEFAULT_PIPE_VERTEX, const char* fragmentPath=DEFAULT_PIPE_FRAGMENT);
